...
const my3FavoriteTVShows = [ 'Manifest', 'Delete', 'Supernatural' ]
const convertSentence = my3FavoriteTVShows.join(', ').replace(', S', ' e S')
const sentence = `Minhas 3 séries favoritas são: ${convertSentence}`
...
/*
  ...
  caracteres? BOOLEAN."
*/
const amountOfCharacter = 39
const sentencebiggerThirtyNine = typeSentence.length >= amountOfCharacter
const convertStringSentence = String(sentencebiggerThirtyNine)
const convertBooleanForString = convertStringSentence[0].toUpperCase() + convertStringSentence.slice(1)

// console.log(`A string que a "typeSentence" armazena tem mais de ${amountOfCharacter}  
// caracteres? ${convertBooleanForString}.`)
