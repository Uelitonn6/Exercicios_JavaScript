...
let dogName = maleDogNames.concat([ ...femaleDogNames ])
...
dogName.push('Nina')
console.log(dogName)
const initials = `${dogName[0][0]}${dogName[1][0]}${dogName[2][0]}${dogName[3][0]}${dogName[4][0]}`
...
const desset = `${dogName[0].slice(3)}${dogName[1].slice(2)}${dogName[4].slice(2).replace('n', 'd')}`
