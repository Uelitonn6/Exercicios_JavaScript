...
const searchAbacaxi = fruits.includes('abacaxi')
const searchPera = fruits.includes('pera')

// if(searchAbacaxi) {
//     console.log('A string "abacaxi" existe no array fruits.')
// } else if(searchAbacaxi) {
...
for(let i = 0; i < numbers.length; i++) {
    ...
    const number11And90 = number >= 11 && number <= 90
...
let amountBoolean = null
let amountNumber = null
let amountString = null

for(let i = 0; i < crazyArray.length; i++) {
    const arrayElements = typeof crazyArray[i]

    if(arrayElements  === 'boolean') {
      amountBoolean++
    } else if (arrayElements === 'number') {
      amountNumber++
    } else {
      amountString++
    }
...
// console.log(`O crazyArray tem ${amountBoolean} booleans, ${amountNumber} números e ${amountString} strings.`)
/*
  06
...
for(let i = 0; i < randomNumbers.length; i++) {
    ...
    const calcEvenNumber = number % 2 === 0
...
const oddNumberString = oddNumber.join(', ').replace(', 3', ' e 3')
